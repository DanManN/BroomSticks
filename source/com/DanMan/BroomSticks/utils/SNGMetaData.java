...
public class SNGMetaData {
	...
	public static void setIntMetadata(Player player, int value, Plugin plug) {
		player.setMetadata("BroomsInt",
						   new FixedMetadataValue(plug, Integer.valueOf(value)));
	}
	...
	public static void setBroomItemMetadata(Player player, ItemStack value,
											Plugin plug) {
